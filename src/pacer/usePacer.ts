...
import type { Word } from '../core/model/types';
import { dwellMultiplier } from '../core/pacer/dwell';
...
export function lastWordlikeUpTo(words: Word[], from: number): number {
...
export function nearestWordlike(words: Word[], target: number): number {
